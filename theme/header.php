			...
			<div class="container">
				<div class="header-center-wrapper">
					...
					<div class="header-center-buttons">
						...
						<a href="#" class="header-center-buttons__item header-center-notification"
							><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									fill-rule="evenodd"
									clip-rule="evenodd"
									d="M13.0003 19.3349C19.1095 19.3349 21.9357 18.5512 22.2087 15.4055C22.2087 12.262 20.2382 12.4641 20.2382 8.60716C20.2382 5.59444 17.3827 2.16663 13.0003 2.16663C8.61799 2.16663 5.76241 5.59444 5.76241 8.60716C5.76241 12.4641 3.79199 12.262 3.79199 15.4055C4.06602 18.5631 6.89225 19.3349 13.0003 19.3349Z"
									stroke="black"
									stroke-width="2"
									stroke-linecap="round"
									stroke-linejoin="round"
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="catalog-menu-categories">
							<div class="catalog-menu-categories-nav">
								<button class="catalog-menu-categories-nav__item" data-index="0">Люки</button>
								<button class="catalog-menu-categories-nav__item" data-index="1">Лестницы</button>
							</div>
							<ul class="catalog-menu-categories-list">
								<li data-index="0" class="catalog-menu-categories-list__item">
									Люки напольные <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
								...
								<li data-index="1" class="catalog-menu-categories-list__item">
									Люки под покраску <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
								...
								<li data-index="2" class="catalog-menu-categories-list__item">
									Люки нажимные под плитку<svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
								...
								<li data-index="3" class="catalog-menu-categories-list__item">
									Люки сантехнические<svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
							...
							<ul class="catalog-menu-categories-list">
								<li data-index="0" class="catalog-menu-categories-list__item">
									Лестницы напольные <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
								...
								<li data-index="1" class="catalog-menu-categories-list__item">
									Лестницы под покраску <svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
								...
								<li data-index="2" class="catalog-menu-categories-list__item">
									Лестницы нажимные под плитку<svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
								...
								<li data-index="3" class="catalog-menu-categories-list__item">
									Лестницы сантехнические<svg width="10" height="14" viewBox="0 0 10 14" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M1 8.49937H8.89189M8.89189 8.49937L5 4.44531M8.89189 8.49937L5 12.5534"
											stroke="#909CB5"
											stroke-linecap="round"
					...
					<div class="col-lg-9">
						<div class="catalog-menu-body">
							<div class="catalog-menu-category-item">
								<div class="catalog-menu-category-item-nav">
									<button class="catalog-menu-category-item-nav__item" data-index="0">Люки с амортизаторами1 </button>
									<button class="catalog-menu-category-item-nav__item" data-index="1">Люки с электроприводом1</button>
								</div>
								<div class="catalog-menu-category-item-body">
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												...
												<span>Люк  напольный «ЮПИТЕР»1</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												<img src="img/thumb.png" alt="" />
												<span>Люк  напольный «ЮПИТЕР»</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
									...
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												<img src="img/thumb.png" alt="" />
												<span>Люк  напольный «ЮПИТЕР»2</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
							...
							<div class="catalog-menu-category-item">
								<div class="catalog-menu-category-item-nav">
									<button class="catalog-menu-category-item-nav__item" data-index="0">Люки с амортизаторами2 </button>
									<button class="catalog-menu-category-item-nav__item" data-index="1">Люки с электроприводом2</button>
								</div>
								<div class="catalog-menu-category-item-body">
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												<img src="img/thumb.png" alt="" />
												<span>Люк  напольный «ЮПИТЕР»3</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
									...
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												<img src="img/thumb.png" alt="" />
												<span>Люк  напольный «ЮПИТЕР»4</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
							...
							<div class="catalog-menu-category-item">
								<div class="catalog-menu-category-item-nav">
									<button class="catalog-menu-category-item-nav__item" data-index="0">Люки с амортизаторами3 </button>
									<button class="catalog-menu-category-item-nav__item" data-index="1">Люки с электроприводом3</button>
								</div>
								<div class="catalog-menu-category-item-body">
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
										...
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												<img src="img/thumb.png" alt="" />
												<span>Люк  напольный «ЮПИТЕР»5</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
							...
							<div class="catalog-menu-category-item">
								<div class="catalog-menu-category-item-nav">
									<button class="catalog-menu-category-item-nav__item" data-index="0">Люки с амортизаторами 5</button>
									<button class="catalog-menu-category-item-nav__item" data-index="1">Люки с электроприводом5</button>
								</div>
								<div class="catalog-menu-category-item-body">
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
									...
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
												<img src="img/thumb.png" alt="" />
												<span>Люк  напольный «ЮПИТЕР»23</span>
											</a>
										</li>
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
											<a href="#">
						...
						<div class="catalog-menu-body">
							<div class="catalog-menu-category-item">
								<div class="catalog-menu-category-item-nav">
									<button class="catalog-menu-category-item-nav__item" data-index="0">Лестницы с амортизаторами</button>
									<button class="catalog-menu-category-item-nav__item" data-index="1">Лестницы с электроприводом</button>
								</div>
								<div class="catalog-menu-category-item-body">
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
							...
							<div class="catalog-menu-category-item">
								<div class="catalog-menu-category-item-nav">
									<button class="catalog-menu-category-item-nav__item" data-index="0">Люки с амортизаторами </button>
									<button class="catalog-menu-category-item-nav__item" data-index="1">Люки с электроприводом</button>
								</div>
								<div class="catalog-menu-category-item-body">
									<ul class="catalog-menu-category-item-list row">
										<li class="catalog-menu-category-item-list__item col-lg-4 mb-3 col-sm-6">
