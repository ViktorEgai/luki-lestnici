...
<div class="cart_totals cart-total <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div  class="shop_table shop_table_responsive">
		...
		<div class="order-total cart-total-top">
		...
		<div class="cart-total-middle">
			<div class="cart-subtotal cart-total-middle-item">
			...
			<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
				<div class="cart-total-middle-item cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
					<p>
			...
			<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
				...
				<div class=" cart-total-middle-item shipping">
			...
			<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
				<div class=" cart-total-middle-item fee">
			...
			if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) {
				...
				if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) {
					foreach ( WC()->cart->get_tax_totals() as $code => $tax ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
						?>
						<div class=" cart-total-middle-item tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
					...
					?>
					<div class="cart-total-middle-item tax-total">
		...
		<div class="wc-proceed-to-checkout cart-total-bottom">
