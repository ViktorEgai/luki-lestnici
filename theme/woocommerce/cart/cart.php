			...
			<div class="shop_table shop_table_responsive woocommerce-cart-form__contents">				
				...
				<div class="actions">
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon d-flex flex-sm-row flex-column mb-4 " style="max-width: 400px">
							<label for="coupon_code" class="screen-reader-text"><?php esc_html_e( 'Coupon:', 'woocommerce' ); ?></label> <input type="text" name="coupon_code" class=" form__input input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> <button type="submit" style="max-width: 200px" class="ms-sm-3 mt-3 mt-sm-0 btn btn--red <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
