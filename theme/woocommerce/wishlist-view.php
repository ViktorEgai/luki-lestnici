...
<!-- <div class="row">
	<div class="col-lg-3 col-md-4 col-sm-6 mb-4">
		<div class="products-item">
			...
			<a href="#" class="products-item__btn btn btn--transparent">В корзину</a>
		</div>
	</div>
	<div class="col-lg-3 col-md-4 col-sm-6 mb-4">
		<div class="products-item">
...
<div
	...
	<div  class="row wishlist-items-wrapper">
	<?php
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
				<div class="col-lg-3 col-md-4 col-sm-6 mb-4"  id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">					
					...
					<div class="products-item">
						...
						<div class="product-thumbnail products-item__thumb">
							<?php
							/**
						...
						<div class="product-name products-item__title">
							<?php
							/**
						...
						<?php if ( $show_price || $show_price_variations ) : ?>
							<div class="product-price products-item__price">
								<?php
								/**
						...
						<?php if ( $show_stock_status ) : ?>
							<div class="product-stock-status mt-2 mb-3">
								<span class="product-stock-status__title"> Статус: </span>
								<?php
								/**
		...
		<tr>
			 ...
			 */
			?>
			<div colspan="<?php echo esc_attr( $column_count ); ?>" class="wishlist-empty"><?php echo esc_html( apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?></div>
		</tr>
		<?php
	endif;
